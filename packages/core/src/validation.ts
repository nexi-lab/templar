...
export function validateNexusClient(
	...
	if (typeof client !== "object" || client === null) {
		throw new NexusClientError(
			"Nexus client must be an object. Received: " + typeof client,
		);
	}
...
export function validateManifest(
	...
	if (typeof manifest !== "object" || manifest === null) {
		throw new ManifestValidationError(
			"Manifest must be an object. Received: " + typeof manifest,
		);
	}

	// Required fields
	const requiredFields: (keyof AgentManifest)[] = [
		"name",
		"version",
		"description",
	];
	...
	if (manifest.channels !== undefined && !Array.isArray(manifest.channels)) {
		throw new ManifestValidationError(
			"Manifest field 'channels' must be an array",
		);
	}

	if (
		manifest.middleware !== undefined &&
		!Array.isArray(manifest.middleware)
	) {
		throw new ManifestValidationError(
			"Manifest field 'middleware' must be an array",
		);
	}
}
