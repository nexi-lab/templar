...
describe("validation", () => {
	describe("validateAgentType", () => {
		...
		it("should reject numeric values", () => {
			expect(() => validateAgentType("123" as string)).toThrow(
				TemplarConfigError,
			);
		});
	});
	...
	describe("validateNexusClient", () => {
		...
		it("should reject non-object", () => {
			expect(() =>
				validateNexusClient("not an object" as unknown as NexusClient),
			).toThrow(NexusClientError);
		});
		...
		it("should reject client missing connect method", () => {
			...
			expect(() => validateNexusClient(invalidClient)).toThrow(
				NexusClientError,
			);
			expect(() => validateNexusClient(invalidClient)).toThrow(
	...
	describe("validateManifest", () => {
		...
		it("should reject null", () => {
			expect(() =>
				validateManifest(null as unknown as AgentManifest),
		...
		it("should reject non-object", () => {
			expect(() =>
				validateManifest("not an object" as unknown as AgentManifest),
			).toThrow(ManifestValidationError);
		});
		...
		it("should reject non-array channels", () => {
			...
			expect(() => validateManifest(manifest)).toThrow(
				"field 'channels' must be an array",
			);
		});
		...
		it("should reject non-array middleware", () => {
			...
			expect(() => validateManifest(manifest)).toThrow(
				"field 'middleware' must be an array",
			);
		});
	});
});
