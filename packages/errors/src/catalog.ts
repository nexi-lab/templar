...
export const ERROR_CATALOG = {
  ...
  GATEWAY_DELEGATION_NODE_UNAVAILABLE: {
    domain: "gateway",
    httpStatus: 502,
    grpcCode: "UNAVAILABLE" as const,
    baseType: "ExternalError" as const,
    isExpected: false,
    title: "Delegation node unavailable",
    description: "The target node for delegation is unreachable or its circuit breaker is open",
  },
  GATEWAY_DELEGATION_REFUSED: {
    domain: "gateway",
    httpStatus: 403,
    grpcCode: "PERMISSION_DENIED" as const,
    baseType: "PermissionError" as const,
    ...
    description: "The target node refused the delegated task",
  },
  GATEWAY_DELEGATION_TIMEOUT: {
    domain: "gateway",
    httpStatus: 504,
    grpcCode: "DEADLINE_EXCEEDED" as const,
    baseType: "TimeoutError" as const,
    ...
    description: "The delegated task exceeded its timeout budget",
  },
  GATEWAY_DELEGATION_EXHAUSTED: {
    domain: "gateway",
    httpStatus: 503,
    grpcCode: "UNAVAILABLE" as const,
    baseType: "ExternalError" as const,
    isExpected: false,
    title: "Delegation exhausted",
    description: "All candidate nodes (primary and fallbacks) failed the delegated task",
  },
  GATEWAY_DELEGATION_NOT_FOUND: {
    domain: "gateway",
    httpStatus: 404,
    grpcCode: "NOT_FOUND" as const,
    baseType: "NotFoundError" as const,
    ...
    description: "No active delegation exists with the specified ID",
  },
  GATEWAY_DELEGATION_INVALID: {
    domain: "gateway",
    httpStatus: 400,
    grpcCode: "INVALID_ARGUMENT" as const,
    baseType: "ValidationError" as const,
    isExpected: true,
    title: "Invalid delegation request",
    description: "The delegation request failed validation (missing fields, capacity exceeded)",
  },
  // ============================================================================
  ...
  // ============================================================================
  COLLABORATION_CONFIGURATION_INVALID: {
    domain: "collaboration",
    httpStatus: 400,
    grpcCode: "INVALID_ARGUMENT" as const,
    baseType: "ValidationError" as const,
    isExpected: true,
    title: "Invalid collaboration configuration",
    description: "The collaboration middleware configuration is invalid",
  },
  REACTION_PATTERN_INVALID: {
    domain: "collaboration",
    httpStatus: 400,
    grpcCode: "INVALID_ARGUMENT" as const,
    baseType: "ValidationError" as const,
    isExpected: true,
    title: "Invalid reaction pattern",
    description: "A reaction event pattern is syntactically invalid",
  },
  REACTION_COOLDOWN_ACTIVE: {
    ...
    baseType: "RateLimitError" as const,
    isExpected: true,
    title: "Reaction cooldown active",
    description: "A reaction pattern is within its cooldown period",
  },
  REACTION_EVENT_SOURCE_FAILED: {
    domain: "collaboration",
    httpStatus: 500,
    grpcCode: "INTERNAL" as const,
    baseType: "ExternalError" as const,
    isExpected: false,
    title: "Event source failed",
    description: "The event source for reaction middleware failed",
  },
  VOICE_DRIFT_EXCEEDED: {
    domain: "collaboration",
    httpStatus: 400,
    grpcCode: "INVALID_ARGUMENT" as const,
    baseType: "ValidationError" as const,
    isExpected: true,
    title: "Voice drift exceeded",
    description: "Personality modifier total weight exceeds the configured drift cap",
  },
  VOICE_MEMORY_QUERY_FAILED: {
    domain: "collaboration",
    httpStatus: 500,
    grpcCode: "INTERNAL" as const,
    baseType: "ExternalError" as const,
    isExpected: false,
    title: "Voice memory query failed",
    description: "Failed to query memories for personality modifier derivation",
  },
  VOICE_MODIFIER_UPDATE_TIMEOUT: {
    domain: "collaboration",
    httpStatus: 504,
    grpcCode: "DEADLINE_EXCEEDED" as const,
    baseType: "TimeoutError" as const,
    isExpected: false,
    title: "Voice modifier update timeout",
    description: "The personality modifier update exceeded its timeout",
  },
  DISTILLATION_EXTRACTION_FAILED: {
    domain: "collaboration",
    httpStatus: 500,
    grpcCode: "INTERNAL" as const,
    baseType: "ExternalError" as const,
    isExpected: false,
    title: "Distillation extraction failed",
    description: "Memory extraction from conversation failed",
  },
  DISTILLATION_EXTRACTION_TIMEOUT: {
    domain: "collaboration",
    httpStatus: 504,
    grpcCode: "DEADLINE_EXCEEDED" as const,
    baseType: "TimeoutError" as const,
    isExpected: false,
    title: "Distillation extraction timeout",
    description: "Memory extraction exceeded its timeout",
  },

  // ============================================================================
  // FEDERATION ERRORS — Multi-zone coordination + edge sync (#202)
  // ============================================================================
  FEDERATION_ZONE_NOT_FOUND: {
    domain: "federation",
    httpStatus: 404,
    grpcCode: "NOT_FOUND" as const,
    baseType: "NotFoundError" as const,
    ...
    description: "The requested zone does not exist or has been terminated",
  },
  FEDERATION_ZONE_ALREADY_EXISTS: {
    domain: "federation",
    httpStatus: 409,
    grpcCode: "ALREADY_EXISTS" as const,
    baseType: "ConflictError" as const,
    ...
    description: "A zone with the given ID already exists",
  },
  FEDERATION_ZONE_INVALID_ID: {
    domain: "federation",
    httpStatus: 400,
    grpcCode: "INVALID_ARGUMENT" as const,
    baseType: "ValidationError" as const,
    ...
    description: "Zone ID must match pattern [a-z0-9][a-z0-9-]{1,61}[a-z0-9]",
  },
  FEDERATION_ZONE_TERMINATING: {
    domain: "federation",
    httpStatus: 409,
    grpcCode: "FAILED_PRECONDITION" as const,
    baseType: "ConflictError" as const,
    isExpected: true,
    title: "Zone is terminating",
    description: "Zone is currently being deprovisioned and cannot accept new operations",
  },
  FEDERATION_ZONE_SHARE_FAILED: {
    domain: "federation",
    httpStatus: 502,
    grpcCode: "UNAVAILABLE" as const,
    baseType: "ExternalError" as const,
    isExpected: false,
    title: "Zone share failed",
    description: "Failed to share zone subtree with peer",
  },
  FEDERATION_ZONE_JOIN_FAILED: {
    domain: "federation",
    httpStatus: 502,
    grpcCode: "UNAVAILABLE" as const,
    baseType: "ExternalError" as const,
    isExpected: false,
    title: "Zone join failed",
    description: "Failed to join peer's shared zone",
  },
  FEDERATION_SYNC_DISCONNECTED: {
    domain: "federation",
    httpStatus: 503,
    grpcCode: "UNAVAILABLE" as const,
    baseType: "ExternalError" as const,
    isExpected: false,
    title: "Edge sync disconnected",
    description: "Edge sync connection lost and reconnection failed",
  },
  FEDERATION_SYNC_AUTH_FAILED: {
    domain: "federation",
    httpStatus: 401,
    grpcCode: "UNAUTHENTICATED" as const,
    baseType: "PermissionError" as const,
    isExpected: true,
    title: "Edge sync auth refresh failed",
    description: "Authentication refresh during reconnection failed",
  },
  FEDERATION_SYNC_TIMEOUT: {
    domain: "federation",
    httpStatus: 504,
    grpcCode: "DEADLINE_EXCEEDED" as const,
    baseType: "TimeoutError" as const,
    isExpected: false,
    title: "Edge sync timeout",
    description: "Edge sync phase exceeded its timeout",
  },
  FEDERATION_CONFLICT_UNRESOLVED: {
    domain: "federation",
    httpStatus: 409,
    grpcCode: "ABORTED" as const,
    baseType: "ConflictError" as const,
    ...
    description: "True conflict detected that requires manual resolution",
  },
  FEDERATION_SYNC_INVALID_TRANSITION: {
    domain: "federation",
    httpStatus: 400,
    grpcCode: "FAILED_PRECONDITION" as const,
    baseType: "ValidationError" as const,
    isExpected: true,
    title: "Invalid sync state transition",
  ...
  FEDERATION_CONFIGURATION_INVALID: {
    ...
    baseType: "ValidationError" as const,
    isExpected: true,
    title: "Invalid federation configuration",
    description: "The federation configuration is invalid or incomplete",
  },
} as const;
